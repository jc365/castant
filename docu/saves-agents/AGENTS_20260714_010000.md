...
│   │   │   ├── use-cases/       ← CreateUserUseCase, GetAllUsersUseCase, CreateCastingUseCase, SubmitVideoUseCase, ManageRoundParticipantsUseCase, ReviewSubmissionUseCase
│   │   │   └── dtos/            ← CreateUserInput, CreateCastingInput, SubmitVideoInput, ManageRoundParticipantsInput, ReviewSubmissionInput, ReviewSubmissionOutput
│   │   ├── infrastructure/
