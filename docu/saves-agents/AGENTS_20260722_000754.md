...
- **`VideoPlayerModal`** (`src/components/VideoPlayerModal.tsx`): Modal de reproductor de videos. Detecta automáticamente YouTube/Vimeo/URLs locales. YouTube/Vimeo usan iframe embed; locales usan `<video>` HTML5. Autoplay, cierre con Escape/backdrop/botón X.
