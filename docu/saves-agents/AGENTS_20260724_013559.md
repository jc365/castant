...
- **`Dashboard`** (`src/pages/Dashboard.tsx`): Panel principal con métricas (KPI cards: Total Castings, Active Castings, Reviewed, Pending), gráficos de barras CSS (Submissions per Round, Score Distribution), actividad reciente, y grid de castings del usuario.
