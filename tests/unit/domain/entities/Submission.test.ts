...
describe('Submission Entity', () => {
  const id = EntityId.create<'Submission'>('sub-1');
  ...
  it('should create a submission with pending status', () => {
    const sub = Submission.create(id, actorId, roundId, videoUrl);
  ...
  it('should preserve immutability across state transitions', () => {
    const original = Submission.create(id, actorId, roundId, videoUrl);
